...
int main(int argc, const char * argv[]) {
    VirtualRouter router1("192.168.43.230", 2345, 23333, VirtualRouter::LS);
    ...
    router1.addNeighborRouter("192.168.43.235", 2345);
    router1.addNeighborRouter("192.168.43.220", 2345);
